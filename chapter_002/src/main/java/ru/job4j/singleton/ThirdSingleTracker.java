...
/**
 * ThirdSingleTracker.
 * Сlass provides only one instance with Eager loading.
 * Instance stores as static final field.
 *
 * @author Mikhail Klimentyev
 * @version $Id$
 * @since 02/03/2019
 */
public class ThirdSingleTracker {
    /**
     * Инстанс.
     */
    private static final ThirdSingleTracker INSTANCE = new ThirdSingleTracker();
     ...
     * Конструктор.
     */
    private ThirdSingleTracker() {
    }

    public static ThirdSingleTracker getInstance() {
        return INSTANCE;
    }
