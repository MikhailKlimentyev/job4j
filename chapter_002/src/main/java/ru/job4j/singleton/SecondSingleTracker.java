...
/**
 * SecondSingleTracker.
 * Сlass provides only one instance with Lazy loading.
 * Instance stores as static field.
 *
 * @author Mikhail Klimentyev
 * @version $Id$
 * @since 02/03/2019
 */
public class SecondSingleTracker {
    /**
     * Инстанс.
     */
    private static SecondSingleTracker instance;
     ...
     * Конструктор.
     */
    private SecondSingleTracker() {
    }

    /**
     * getInstance.
     * Проверяет существует ли инстанс класса,
     * если да, то возвращает его,
     * если нет, то создает и возвращает созданный инстанс.
     *
     * @return инстанс.
     */
    public static SecondSingleTracker getInstance() {
        if (instance == null) {
            instance = new SecondSingleTracker();
        }
        return instance;
    }
