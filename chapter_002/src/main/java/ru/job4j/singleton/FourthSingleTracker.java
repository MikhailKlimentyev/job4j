 ...
 * Instance stores inside private static final class.
 *
 * @author Mikhail Klimentyev
 * @version $Id$
 * @since 02/03/2019
 */
public class FourthSingleTracker {
    /**
     ...
     * Конструктор.
     */
    private FourthSingleTracker() {
    }

    /**
     * Возвращает инстнанс класса.
     *
     * @return инстанс.
     */
    public static FourthSingleTracker getInstance() {
    ...
    /**
     * Holder.
     * Создает инстанс FourthSingleTracker класса.
     */
    private static final class Holder {
        private static final FourthSingleTracker INSTANCE = new FourthSingleTracker();
    }
}
